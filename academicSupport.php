...
<html lang="en">
  <head>
    <title>প্রাতিষ্ঠানিক সহযোগিতা</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
        ...
        <section class="mainBody my-3">
            <div class="row mx-1">
                <div class="col-xl-12 col-md-12 col-sm-12 col-12 p-0">
                    <h3>প্রাতিষ্ঠানিক সহযোগিতা</h3>
                    <h6>প্রচ্ছদ / প্রাতিষ্ঠানিক সহযোগিতা</h6>
            ...
            <div class="row mx-1 my-3">
                ...
                <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12 col-12 text-justify">
                  <?php echo '<img src="data:image;base64,'.base64_encode($acamdic_support['image']).'"alt="institute image" class="img-fluid mb-5">'; ?>
                    <!-- <img src="static/images/institute.jpg" alt="institute image" class="img-fluid"> -->
                    <div class="institueDetails my-4">
                        <p class="text-justify">
                            <?php echo $acamdic_support['qoutes'] ?>
                        </p><br>
                    </div>
