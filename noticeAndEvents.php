<?php
  ...
  $content = mysqli_fetch_array(mysqli_query($con , $query));
...
<html lang="en">
  ...
  <body>
        ...
        <section class="mainBody my-3">
            <div class="row mx-1">
                <div class="col-xl-12 col-md-12 col-sm-12 col-12 p-0">
                    <h3>নোটিশ ও কর্মসূচী</h3>
                    <h6>প্রচ্ছদ / নোটিশ ও কর্মসূচী</h6>
            ...
            <div class="row mx-1 my-3">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 text-justify">
                    <div class="row" style="justify-content: space-between;">
                       <button class="btn btn-success"  > <i class="fa fa-arrow-left" aria-hidden="true"></i> Prev</button>
                       <p><span class="font-weight-bold"><?php echo $content['date'] ?></span></p>   
                       <button class="btn btn-success">Next <i class="fa fa-arrow-right" aria-hidden="true"></i> </button>
                    </div>   
                    <div class="my-5 text-center">
                      <hr><span class="font-weight-bold"><?php echo $content['heading'] ?></span><hr>
                    </div>
                    <div class="row">
                      <div class="container">
    ...
    <script>
      function previous(table, id, maxId) {
        // id--;
        // if(id != 0){
        //   location.assign('noticeAndEvents.php?table='+table+'&id='+id);
        // }
      }
      function next(table , id, maxId) {
        // if(id != maxId){
        //   id++;
        //   location.assign('noticeAndEvents.php?table='+table+'&id='+id);
        // }
