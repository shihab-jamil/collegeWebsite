                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                    <div class="row">
                      <?php while ($row = mysqli_fetch_array($result)) {
                          ?>
                          <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12 mb-5  text-center">
                            <?php echo '<img src="data:image;base64,'.base64_encode($row['image']).'"alt="image" class="img-fluid">'; ?>
                            <p class="mt-2 text-justify"><?php echo $row['details'] ?></p>
                        </div> <?php
                      } ?>
                    </div>
