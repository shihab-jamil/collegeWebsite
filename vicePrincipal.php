<?php
  ...
  $query = "SELECT * FROM authorities WHERE category='vice_principal'";
        ...
        <section class="mainBody my-3">
            <div class="row mx-1">
                <div class="col-xl-12 col-md-12 col-sm-12 col-12 p-0">
                    <h3>সহকারী অধ্যক্ষ</h3>
                    <h6>প্রচ্ছদ / কর্তৃপক্ষ / সহকারী অধ্যক্ষ</h6>
            ...
            <div class="row mx-1 my-3">
                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                    <div class="pathBox">
                        ...
                        <ul>
                            <li ><a  href="moderator.php">সভাপতি</a></li>
                            <li><a  href="chairman.php">চেয়ারম্যান</a></li>
                            <li><a   href="principal.php">অধ্যক্ষ</a></li>
                            <li><a class="text-warning" href="#">সহকারী অধ্যক্ষ</a></li>
                        </ul>
                    </div>
                    <div class="row mb-3">
                ...
                <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12 col-12 text-justify">
                    <?php echo '<img src="data:image;base64,'.base64_encode($row['image']).'"alt="institute image" class="img-fluid mr-3" style="float: left;">'; ?>
                    <!-- <img src="static/images/principal.png" alt="institute image" class="img-fluid mr-3" style="float: left;"> -->
                    <div class="personInfo">
                        <h3><?php echo $row['name']  ?></h3>
                        <p>উপধ্যক্ষ</p>
                    </div>
                    
                    <div class="institueDetails my-5" style="clear: left;">
                        ...
                        <p>
                            ...
                            <p class="mt-0"><span class="font-weight-bold">ইমেইল : </span><?php echo $row['email'] ?></p>
                        </p>
                    </div>
