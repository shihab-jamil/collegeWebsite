        ...
        <section class="mainBody my-3">
          ...
          <div class="row mx-1 my-3">
            <!-- <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                <div class="pathBox">
                    ...
                    <ul>
                        ...
                        <li><a class="text-warning" href="#">রুটিন</a></li>
                  ...
                  <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 my-3">
                    ...
                    <div class="noticeBox">
                      <ul>
                        <li>
                          <a href="#">
                            <label class="mb-0">১২ জুন, ২০২০</label>
                            <p class="text-justify">অর্থহীন লেখা যার মাঝে আছে অনেক কিছু। হ্যাঁ, এই লেখার মাঝেই আছে অনেক কিছু।</p>
                          </a>
                        </li>
                        <li>
                          <a href="#">
                    ...
                    <div class="allNotice">
                      <a href="#"><i class="fa fa-plus-circle" aria-hidden="true"><span class="ml-2">আরও দেখুন</span></i></a>
                    </div> 
                  </div>
                </div>
            </div> -->
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
              <div class="row">
                <p><?php echo $academic_routine['details'] ?></p>
              </div>
