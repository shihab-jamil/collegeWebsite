        ...
        <section class="mainBody my-3">
            <div class="row mx-1">
                <div class="col-xl-12 col-md-12 col-sm-12 col-12 p-0">
                    <h3>শিক্ষকবৃন্দ</h3>
                    <h6>প্রচ্ছদ / একাডেমিক / শিক্ষকবৃন্দ</h6>
            ...
            <div class="row mx-1 my-3">
                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                    <div class="pathBox">
                        ...
                        <ul>
                            <li ><a  href="deaprtments.php">বিভাগ</a></li>
                            <li><a class="text-warning" href="#">শিক্ষকবৃন্দ</a></li>
                            <li><a   href="routine.php">রুটিন</a></li>
                            <li><a href="academicCalender.php">একাডেমিক ক্যলেন্ডার</a></li>
                            <li><a href="stuffs.php">কর্মকর্তা কর্মচারী</a></li>
                        </ul>
                    </div>
                    <div class="row mb-3">
                      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 my-3">
                        ...
                        <div class="noticeBox events scrollbar-primary">
                          <ul>
                            <?php while ($rowN = mysqli_fetch_array($notice)) {
                              ?>
                              <li onclick="noticeEventViewer('notice' , <?php echo $row['Id'] ?>)">
                                <a href="#">
                                  <label class="mb-0"><?php echo $rowN['date'] ?></label>
                                  <p class="text-justify"><?php echo $rowN['heading'] ?></p>
                                </a>
                              </li> <?php
                            } ?> 
                          </ul>
                ...
                <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12 col-12 text-justify">
                      <div class="row" style="justify-content: space-between;">
                        <?php while ($row = mysqli_fetch_array($result)) {
                           ?> 
                          <div class="card mb-4" style="width: 12rem;" data-toggle="modal" data-target="<?php $pn =  $row['id'];  echo '#'.$pn; ?>">
                              <!--tips: add .text-center,.text-right to the .card to change card text alignment-->
                              <!-- <img src="static/images/teacher1.jpg" class="card-img-top" alt="..."> -->
                              <?php echo '<img src="data:image;base64,'.base64_encode($row['image']).'"alt="institute image" class="card-img-top">'; ?>
                              <div class="card-body">
                                  <h5 class="card-title text-center"><?php echo $row['name'] ?></h5>
                              </div>
                          </div>
                          <div class="modal fade" id="<?php echo $row['id']  ?>" tabindex="-1" role="dialog" aria-labelledby="myModal-label" aria-hidden="true">
                              <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                  <div class="modal-header">
                                    <h5 class="modal-title" id="myModalTitle">শিক্ষকদের তথ্য</h5>
                                  ...
                                  <div class="modal-body">
                                    <div class="row">
                                      ...
                                      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                        <p><span class="font-weight-bold">নাম : </span><?php echo $row['name']  ?></p>
                                        <p><span class="font-weight-bold">পদবী : </span><?php echo $row['position']  ?></p>
                                        <p><span class="font-weight-bold">বিষয় : </span><?php echo $row['subject']  ?></p>
                                        <p><span class="font-weight-bold">মোবাইল : </span><?php echo $row['phone_number']  ?></p>
                                        <p><span class="font-weight-bold">ই-মেইল : </span><?php echo $row['email']  ?></p>
                                        <p><span class="font-weight-bold">NID : </span><?php echo $row['nid']  ?></p>
                                      </div>
                                    </div>
                                  </div>
