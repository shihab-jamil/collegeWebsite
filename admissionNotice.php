        ...
        <section class="mainBody my-3">
            <div class="row mx-1">
                <div class="col-xl-12 col-md-12 col-sm-12 col-12 p-0">
                    <h3>ভর্তি বিজ্ঞপ্তি</h3>
                    <h6>প্রচ্ছদ / ভর্তি / ভর্তি বিজ্ঞপ্তি</h6>
            ...
            <div class="row mx-1 my-3">
                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                    <div class="pathBox">
                        ...
                        <ul>
                            <li ><a  href="admissionResult.php">ফলাফল</a></li>
                            <li><a  href="admissionRequirment.php">যোগ্যতা</a></li>
                            <li><a class="text-warning"  href="#">ভর্তি বিজ্ঞপ্তি</a></li>
                ...
                <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12 col-12 text-justify">
                    <p><?php echo $admissionNotice['details'] ?></p>
