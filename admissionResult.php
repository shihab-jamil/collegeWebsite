...
<html lang="en">
  ...
  <body>
            ...
            <div class="row mx-1 my-3">
                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                    <div class="pathBox">
                        ...
                        <ul>
                            <li ><a class="text-warning" href="#">ফলাফল</a></li>
                            <li><a  href="admissionRequirment.php">যোগ্যতা</a></li>
                            <li><a   href="admissionNotice.php">ভর্তি বিজ্ঞপ্তি</a></li>
                            <li><a href="admissionProcedure.php">ভর্তি পদ্ধতি</a></li>
                        </ul>
                    </div>
                    <div class="row mb-3">
                ...
                <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12 col-12 text-justify">
                    <div class="row">
                      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <h3>ভর্তি ফলাফল</h3>
                        <ul class="results">
                          <li><a href="#" onclick="admissionResult('science' , 'admission')" >বিজ্ঞান</a></li>
                          <li><a href="#" onclick="admissionResult('arts', 'admission')">মানবিক</a></li>
                          <li><a href="#" onclick="admissionResult('commerce', 'admission')">ব্যবসায় শিক্ষা</a></li>
                          <li><a href="#" onclick="admissionResult('bm', 'admission')">ব্যবসায় ব্যবস্থাপনা</a></li>
                        </ul>
                      </div>
                    </div>
    ...
    <script>
      function admissionResult(dept , result) {
        location.assign('resultSheet.php?dept='+dept+'&result='+result);
      }
