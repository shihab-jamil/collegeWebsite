<?php
    include('config.php');
    if($_GET['result'] == 'admission'){
        if($_GET['dept'] == 'science'){
            $query = "SELECT * FROM admission_result WHERE dept='science'";
        }elseif ($_GET['dept'] == 'arts') {
            $query = "SELECT * FROM admission_result WHERE dept='arts'";
        }elseif ($_GET['dept'] == 'commerce') {
            $query = "SELECT * FROM admission_result WHERE dept='commerce'";
        }elseif ($_GET['dept'] == 'bm') {
            $query = "SELECT * FROM admission_result WHERE dept='bm'";
        }
        $table = mysqli_fetch_array(mysqli_query($con , $query));
    }
