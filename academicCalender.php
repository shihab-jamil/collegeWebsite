...
<html lang="en">
  <head>
    <title>একাডেমিক ক্যলেন্ডার</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
        ...
        <section class="mainBody my-3">
            <div class="row mx-1">
                <div class="col-xl-12 col-md-12 col-sm-12 col-12 p-0">
                    <h3>একাডেমিক ক্যলেন্ডার</h3>
                    <h6>প্রচ্ছদ / একাডেমিক / একাডেমিক ক্যলেন্ডার</h6>
                ...
                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                    <div class="pathBox">
                        ...
                        <ul>
                            ...
                            <li><a class="text-warning" href="#">একাডেমিক ক্যলেন্ডার</a></li>
