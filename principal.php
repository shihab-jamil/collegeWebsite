<?php
  ...
  $query = "SELECT * FROM authorities WHERE category='principal'";
        ...
        <section class="mainBody my-3">
            <div class="row mx-1">
                <div class="col-xl-12 col-md-12 col-sm-12 col-12 p-0">
                    <h3>অধ্যক্ষ</h3>
                    <h6>প্রচ্ছদ / কর্তৃপক্ষ / অধ্যক্ষ</h6>
                ...
                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                    <div class="pathBox">
                        ...
                        <ul>
                            ...
                            <li><a  class="text-warning" href="#">অধ্যক্ষ</a></li>
                            <li><a href="vicePrincipal.php">সহকারী অধ্যক্ষ</a></li>
                        </ul>
                    </div>
                    <div class="row mb-3">
