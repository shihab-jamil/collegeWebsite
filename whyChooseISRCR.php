        ...
        <section class="mainBody my-3">
            <div class="row mx-1">
                <div class="col-xl-12 col-md-12 col-sm-12 col-12 p-0">
                    <h3>কেন ইশিম</h3>
                    <h6>প্রচ্ছদ / আমাদের সম্পর্কে / কেন ইশিম</h6>
            ...
            <div class="row mx-1 my-3">
                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                    <div class="pathBox">
                        ...
                        <ul>
                            ...
                            <li><a class="text-warning" href="#">কেন ইশিম</a></li>
                            <li><a href="genaralInformation.php">সাধারণ তথ্য</a></li>
                ...
                <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12 col-12 text-justify">
                    <button class="btn-danger text-white btn-block"><h3>ইশিম সম্পর্কে ২০টি তথ্য</h3></button>
                    <p><?php echo $whyChoose['qoutes'] ?></p>
