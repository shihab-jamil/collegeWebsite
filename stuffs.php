<?php
  ...
  $stuffs = mysqli_query($con , $query);

  $query = "SELECT * FROM fourth_grade_stuffs";
  $fgstuffs = mysqli_query($con , $query);
        ...
        <section class="mainBody my-3">
            <div class="row mx-1">
                <div class="col-xl-12 col-md-12 col-sm-12 col-12 p-0">
                    <h3>কর্মকর্তা কর্মচারী</h3>
                    <h6>প্রচ্ছদ / একাডেমিক / কর্মকর্তা কর্মচারী</h6>
            ...
            <div class="row mx-1 my-3">
                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                    <div class="pathBox">
                        ...
                        <ul>
                            ...
                            <li><a class="text-warning" href="#">কর্মকর্তা কর্মচারী</a></li>
                        </ul>
                    </div>
                    <div class="row mb-3">
                ...
                <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12 col-12 text-justify">
                  <hr><h3 class="text-center">অফিস পরিচিতি</h3> <hr>
                      <div class="row" style="justify-content: space-between;">
                        <?php while ($row = mysqli_fetch_array($stuffs)) {
                           ?> 
                              ...
                              <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                  <div class="modal-header">
                                    <h5 class="modal-title" id="myModalTitle">অফিস পরিচিতি</h5>
                  ...
                  <hr><h3 class="text-center">৪র্থ শ্রেনীর কর্মচারী</h3> <hr>
                      <div class="row" style="justify-content: space-between;">
                        <?php while ($row = mysqli_fetch_array($fgstuffs)) {
                           ?> 
                          <div class="card mb-4" style="width: 12rem;" data-toggle="modal" data-target="<?php $pn =  $row['id'];  echo '#'.$pn; ?>">
                              <!--tips: add .text-center,.text-right to the .card to change card text alignment-->
                              <!-- <img src="static/images/teacher1.jpg" class="card-img-top" alt="..."> -->
